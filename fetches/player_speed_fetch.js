...
function convertPlayerStatsToCSV(data) {
    const headers = [
        ...
        "onfield_time_first", "onfield_time_second",
    ...
    const rows = data.map(({ tournamentId, matchId, players }) => {
        return players.map(player => {
            ...
            return [
                ...
                period1.movementStatistics?.timeOnField || 0,
                period2.movementStatistics?.timeOnField || 0,
                period1.movementStatistics?.distanceTravelled || 0,
                period2.movementStatistics?.distanceTravelled || 0,
